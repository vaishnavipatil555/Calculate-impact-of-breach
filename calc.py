...
def result():
    ...
    res = get_res(VM, tcp_cost, udp_cost, icmp_cost, tot_nodes)
    ...
    return render_template('result1.html', legend_udp=legend_udp, legend_tcp=legend_tcp, legend_icmp=legend_icmp, VM=get_corresponding_ip(VM), ans=ans, tree_udp=tree_udp, tree_tcp=tree_tcp, tree_icmp=tree_icmp, impacted_nodes=impacted_nodes, cost=cost)
